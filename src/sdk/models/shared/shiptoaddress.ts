...
export class ShipToAddress extends SpeakeasyBase {
    /**
    ...
    /**
     * ISO 3166 country code for the country the address is located in. https://www.iso.org/iso-3166-country-codes.html
     */
    @SpeakeasyMetadata()
    @Expose({ name: "Country" })
    country: string;
